...
class ItemRepositoryTest < Minitest::Test
  ...
  def test_all
    assert_equal 3, item_repo.all.size
  end
  ...
  def test_find_by_item_id
    item = item_repo.find_by_item_id(7)

    assert_equal 7, item.id
  end

  def test_find_by_name
    item = item_repo.find_by_name("Item")
  ...
  def test_find_by_unit_price
    ...
    item = item_repo.find_by_unit_price(price)
  ...
  def test_find_all_by_name
    item = item_repo.find_all_by_name("Item")
  ...
  def test_find_all_by_unit_price
    item = item_repo.find_all_by_unit_price(BigDecimal.new("67076") / 100)
