...
class InvoiceItemRepoTest < Minitest::Test
  attr_reader :invoice_item_repo, :sales_engine
  ...
  def test_find_all_by_unit_price
    price = BigDecimal.new("13635") / 100

    invoice_items = invoice_item_repo.find_all_by_unit_price(price)
  ...
  def test_find_all_by_created_at
    found_date = Date.parse("2012-03-27 14:54:09 UTC")
    not_found_date = Date.parse("2016-01-01")

    invoice_items = invoice_item_repo.find_all_by_created_at(found_date)
    invoice_items1 = invoice_item_repo.find_all_by_created_at(not_found_date)
  ...
  def test_find_all_by_updated_at
    ...
    invoice_items = invoice_item_repo.find_all_by_updated_at(found_date)
    invoice_items1 = invoice_item_repo.find_all_by_updated_at(not_found_date)
